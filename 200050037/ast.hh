...
{
public:
	stringconst_astnode(std::string value, int numpf);
	void print(int ntabs);
	void gencode(int a);
	// protected:
	std::string value;
...
{
public:
	identifier_astnode(std::string val, int off, int isz, bool is_arr, int derf, bool istr, int issz);
	void print(int ntabs);
	void gencode(int a);
...
{
public:
	arrayref_astnode(exp_astnode *left, exp_astnode *right, int aoff);
	void print(int ntabs);
	void gencode(int a);
